    ...
    <>
      <div className="content-block dx-card responsive-paddings delivery-container">
        <div className="header-section">
          ...
          <PopupSubText
            text={"To pick and deliver the items"}
            className="subText"
          />
        </div>
        ...
        <QtcSearchColumn
          popupHeaderText="Delivery"
          popupSubHeaderText="To pick and deliver the items"
          optionFunc={helpOptions}
          keyArray={keyArray1}
          PopUpContent={getPoLists()}
          getparamFunc={handlePoVerification}
          valueToShowParam="qrCodeID"
          keyExpr="docEntry"
        />
        ...
        {grpoList.size > 0 && (
          <QtcMainColumn
            IQCList={grpoList}
            columns={columns}
            handleProceed1={proceedToItemsScan}
            displayname="headerQRCodeID"
            DownArrowKey="docEntry"
            keyExpr="docEntry"
          />
        )}
      </div>
